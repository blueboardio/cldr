// Code generated by "go run -modfile ../gen/go.mod ../gen/gen-countries/main.go cldr-common-45.0.zip"; DO NOT EDIT.
...
var Countries = map[Code]*Info{
	...
	"CQ": {Code: "CQ", Name: "Sark"},
	"CR": {Code: "CR", Name: "Costa Rica", Currencies: []currency.Code{"CRC"}},
	"CU": {Code: "CU", Name: "Cuba", Currencies: []currency.Code{"CUP"}},
	"CV": {Code: "CV", Name: "Cape Verde", Currencies: []currency.Code{"CVE"}},
	"CW": {Code: "CW", Name: "Curaçao", Currencies: []currency.Code{"XCG"}},
	...
	"SX": {Code: "SX", Name: "Sint Maarten", Currencies: []currency.Code{"XCG"}},
	...
	"TR": {Code: "TR", Name: "Türkiye", Currencies: []currency.Code{"TRY"}},
