// Code generated by "go run countries_gen.go cldr-common-33.0.zip"; DO NOT EDIT.
...
var Countries = map[Code]*Info{
	...
	"MK": {Code: "MK", Name: "Macedonia", Currencies: []currency.Code{"MKD"}},
	...
	"MO": {Code: "MO", Name: "Macau SAR China", Currencies: []currency.Code{"MOP"}},
	...
	"SZ": {Code: "SZ", Name: "Swaziland", Currencies: []currency.Code{"SZL"}},
	...
	"VE": {Code: "VE", Name: "Venezuela", Currencies: []currency.Code{"VEF"}},
